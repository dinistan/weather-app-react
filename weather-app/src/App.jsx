...
function App() {
  let api_key = "c7dc38066822c0ff6bc0355f0451516b";
  ...
  return (
    <>
      <div className='container'>
        ...
        {!loading &&  !cityNotFound && <WeatherDeatils icon={icon} temp={temp} city={city} country={country}
        lat={lat} log={log} humidity={humidity} wind={wind} />}


        <p className='copyright'>Designed by <span>Dinistan Ajay</span></p>
      </div>
    </>
  )
}
